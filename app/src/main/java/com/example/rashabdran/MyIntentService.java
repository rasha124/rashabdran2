package com.example.rashabdran;
    ...
    @Override protected void onHandleIntent(@Nullable Intent intent) {
        ...
        nBuilder.setSmallIcon(R.drawable.ic_baseline_block_24);

        //what to do when the notification is clicked
        Intent intent1 = new Intent(this, MainActivity.class);
        PendingIntent pendingIntent =
                PendingIntent.getActivity(this, REQUEST_CODE, intent1,
    ...
    /* *
      * create notification channel and set notification

     importance required for version 8.0 and above
     *  * or sdk 26+
      */
